...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        bottomButton.setTitle("Confirm", for: .normal)
    ...
    @objc func gotoMain() {
        let s = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "SquareHomeViewController") as! SquareHomeViewController
    ...
    func loadCancelData() {
        ...
        DispatchQueue.global().async {
            let urlBase = URL(string: linkGod)
            Alamofire.request(urlBase!,method: .get,parameters: nil,encoding: URLEncoding.default,headers:nil).responseJSON { response
                in
                switch response.result.isSuccess {
                case true:
