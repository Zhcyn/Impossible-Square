//
//  SquarePlayViewController.swift
//  Impossible Square
//
...
class SquarePlayViewController: UIViewController {
    ...
    func setUpSquare() {
        if squareFace == 0 {
            imgOutlet.image = #imageLiteral(resourceName: "square")
        } else if squareFace == 1 {
            imgOutlet.image = #imageLiteral(resourceName: "squareRed")
        } else if squareFace == 2 {
            imgOutlet.image = #imageLiteral(resourceName: "squareBlue")
        } else if squareFace == 3 {
            imgOutlet.image = #imageLiteral(resourceName: "squareGreen")
        }
    }
